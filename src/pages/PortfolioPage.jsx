...
function PortfolioPage() {
  ...
  const heroImages = [
    ...
    `${import.meta.env.BASE_URL}gymme2.jpg`,
    `${import.meta.env.BASE_URL}gymme.jpg`,
    `${import.meta.env.BASE_URL}WhatsApp Image 2026-08-26 at 10.45.20 (3).jpeg`,
    `${import.meta.env.BASE_URL}WhatsApp Image 2026-08-26 at 10.45.21 (1).jpeg`,
    `${import.meta.env.BASE_URL}WhatsApp Image 2026-08-26 at 10.45.22.jpeg`,
    `${import.meta.env.BASE_URL}oldme.jpg`
  ];
  ...
  return (
    <div className="app-container">
        ...
        <div className="hero-content">
          ...
          <div className="button-group" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '10px' }}>
            ...
            <div className="hero-btn-group">
			  ...
			  <a 
				href={`${import.meta.env.BASE_URL}cv new 2026-04-21.pdf`}
          ...
          <div className="project-grid">
			<div className="card project-card">
			  ...
			  <div className="card-actions">
				<a 
				  href="https://github.com/mfaqihmunandar" 
				  target="_blank" 
				  rel="noreferrer" 
				  className="btn-noticeable github-outline-btn"
				>
            ...
            <div className="card project-card">
              ...
              <div className="card-actions">
                <button 
				  ...
				  className="btn-noticeable primary-accent-btn"
				>
      ...
      <section id="offer-message" className="section message-section">
        <div className="content-wrapper message-box">
          ...
          <div className="send-button-group">
            <button className="send-btn email-btn" onClick={handleSendEmail} disabled={!message.trim()}>
              ✉ Send via Email
            </button>
            <button className="send-btn wa-btn" onClick={handleSendWhatsApp} disabled={!message.trim()}>
              💬 Send via WhatsApp
            </button>
          </div>
        </div>
      ...
      <div className={`fab-container ${menuOpen ? 'open' : ''}`}> 
        <button className={`fab-main ${menuOpen ? 'active' : ''}`} onClick={() => setMenuOpen(!menuOpen)}>
        ...
        {contactLinks.map((item, idx) => (
          <a key={idx} href={item.href} target="_blank" rel="noreferrer" className="radial-item" style={{ '--angle': item.angle }}>
            {item.icon}
          </a>
        ))}
      </div>
